                                ...
                                shareBlogItems.map(({ icon: Icon, shareUrl }, idx) => {
                                    ...
                                    return (
                                        <button
                                            ...
                                            key={idx}
                                            className={cn(
                                                "p-2.5 rounded-full border hover:border-purple-500 hover:text-purple-500",
                                                "border-white text-white hover:-translate-y-1.5  hover:scale-100 hover:cursor-pointer",
                                                "transform scale-75 group-hover:scale-95 translate-y-4 group-hover:translate-y-0",
                                                "transition-[transform_colors] duration-300 ease-out",
                                            )}
                                        >
                                            <Icon
                                                className="size-6.5 drop-shadow-xs drop-shadow-black"
                                            />
                                        </button>
                                    )
                                })
