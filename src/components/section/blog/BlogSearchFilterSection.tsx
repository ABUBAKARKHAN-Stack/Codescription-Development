    ...
    <div className="w-full space-y-4">
      ...
      <div className="relative">
        ...
        <input
          ...
          className="w-full rounded-lg border border-slate-700/50 bg-slate-800/50 py-3 pr-4 pl-12 text-slate-200 placeholder-slate-400 backdrop-blur-sm transition-all duration-200 focus:border-purple-500/50 focus:ring-2 focus:ring-purple-500/20 focus:outline-none"
        />
      </div>
        ...
        >
          ...
          {hasActiveFilters && (
            <span className="ml-1 rounded-full bg-purple-600 px-2 py-0.5 text-xs text-white">
              {
                [searchQuery, selectedCategory, selectedTag].filter(Boolean)
                  .length
              }
            </span>
          )}
